...
export default function Referral() {
  ...
  const { props } = usePage();
  const { userType, settings, stats, payoutRequests, referralLink, recentReferredUsers, flash } = props as any;
  ...
  const sidebarNavItems: NavItem[] = [
    ...
    // Referred Users menu - Commented out until data issue resolved
    // {
