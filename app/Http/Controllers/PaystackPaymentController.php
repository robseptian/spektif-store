    ...
    public function processPayment(Request $request)
    {
        ...
        try {
            ...
            if (!isset($settings['payment_settings']['paystack_secret_key'])) {
                return redirect()->route('plans.index')->withErrors(['error' => __('Paystack not configured')]);
            }
            ...
            return redirect()->route('plans.index')->withErrors(['error' => __('Payment verification failed')]);
